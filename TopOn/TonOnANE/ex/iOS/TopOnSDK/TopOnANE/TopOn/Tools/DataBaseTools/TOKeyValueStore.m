...
@interface TOKeyValueStore()

@property (strong, nonatomic) FMDatabaseQueue * dbQueue;

@end

@implementation TOKeyValueStore
...
- (void)createTableWithName:(NSString *)tableName {
    if ([TOKeyValueStore checkTableName:tableName] == NO) {
        return;
    }
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
    TOKeyValueItem * item = [self getTOKeyValueItemById:objectId fromTable:tableName];
    if (item) {
...
- (TOKeyValueItem *)getTOKeyValueItemById:(NSString *)objectId fromTable:(NSString *)tableName {
    if ([TOKeyValueStore checkTableName:tableName] == NO) {
        return nil;
    }
    ...
    if (json) {
        ...
        TOKeyValueItem * item = [[TOKeyValueItem alloc] init];
...
- (NSArray *)getAllItemsFromTable:(NSString *)tableName {
    ...
    NSError * error;
    for (TOKeyValueItem * item in result) {
        error = nil;
