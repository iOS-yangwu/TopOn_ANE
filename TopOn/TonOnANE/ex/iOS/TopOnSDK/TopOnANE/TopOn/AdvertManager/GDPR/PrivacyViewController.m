...
- (void)confirmButtonClick{
    ...
    //[kUserDefault  setInteger:DataConsentSetPersonalized forKey:kGDPRStatus];
...
- (void)cancleButtonClick{
    ...
    //[kUserDefault  setInteger:DataConsentSetNonpersonalized forKey:kGDPRStatus];
    if (self.responeCallback) {
        self.responeCallback();
    }
