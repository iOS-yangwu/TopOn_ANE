...
@interface TOOriginNavtiveAdView ()
...
@implementation TOOriginNavtiveAdView
...
-(void) initSubviews{
    ...
    self.sponsorIV = [[UIImageView alloc]initWithImage:[UIImage nativeDetailLabelBgImageWithImageName:@"sponsorImage"]];
    self.sponsorIV.contentMode = UIViewContentModeScaleAspectFit;
    [self addSubview:self.sponsorIV];
...
-(void) makeConstraintsForSubviews{
    ...
    self.sponsorIV.frame = CGRectMake(0,0,24,19);
